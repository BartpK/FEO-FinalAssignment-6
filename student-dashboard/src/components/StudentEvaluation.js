...
const StudentEvaluations = (props) => {
    const activeStudent = props.match.params.StudentEvaluations;
    console.log(props.evaluations)
    const evaluationsByActiveStudent = props.evaluations.filter(evaluation => {
        return evaluation.student === activeStudent;
    })
    ...
    const getAverageScore = (assignment, category) => {
        const filteredAssignments = evaluationsByActiveStudent.filter(evaluation => {
